...
class RestaurantIntegrationTest {
    ...
    class RegisterRestaurants {
        ...
        void test1() throws JsonProcessingException {
            ...
            System.out.println(Objects.requireNonNull(response.getBody()).id);
            System.out.println(response.getBody().name);
            System.out.println(response.getBody().minOrderPrice);
            System.out.println(response.getBody().deliveryFee);
            // then
